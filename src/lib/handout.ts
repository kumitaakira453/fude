...
const GLYPH: Record<string, string> = {
  ...
  // タスクの印（lib/md/taskMarks.ts）。四角のままにして、中の印だけを変える。
  indeterminate_check_box:
    "M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2zm2 8v2h10v-2z",
  disabled_by_default:
    "M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2zm2.7 3.3L6.3 7.7 10.6 12l-4.3 4.3 1.4 1.4L12 13.4l4.3 4.3 1.4-1.4L13.4 12l4.3-4.3-1.4-1.4L12 10.6z",
  schedule:
    "M12 2a10 10 0 110 20 10 10 0 010-20zm0 2a8 8 0 100 16 8 8 0 000-16zm-.9 2.6h1.8v5.1l3.9 2.3-.9 1.6-4.8-2.8z",
  help: "M12 2a10 10 0 110 20 10 10 0 010-20zm-1.1 15.2h2.2v-2.1h-2.2zm1.1-9.7c-1.7 0-3 1.2-3 2.9h1.9c0-.7.5-1.2 1.1-1.2s1.1.4 1.1 1c0 .5-.3.8-.8 1.2-.8.6-1.3 1.1-1.3 2.3h1.9c0-.6.2-.9.9-1.4.7-.5 1.3-1.2 1.3-2.2 0-1.6-1.4-2.6-3.1-2.6z",
};
