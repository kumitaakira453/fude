...
fude はローカルの Markdown を読み書きするための道具です。まずは[使いはじめ](#使いはじめ)から。版のことは[会話の見本の「版」](./会話の見本.md#版)にあります。
  ...
  threads: [
    {
      ...
      comments: [
        ...
        [
          "AI",
          `書いたものの姿を確かめる口を足しました。直したのは次の 3 つです。
...
\`\`\`ts
const seen = preview(body);
\`\`\`

> 記法はコメントでも本文と同じに組みます。`,
          28,
        ],
        ["you", "ありがとうございます。記法もそのまま出ますか。[版](#版)のあたりにも同じ話が要りそうです。", 27],
      ],
    },
    {
      id: "5a1e0022",
